...
feature_columns = [
    "Probability_sematch_classifier_random_forest", 
    "Eval_spacy_senses", 
...
with open('classifiersematchthenbabelProb.pkl', 'wb') as file:
...
Average F-score: 61.03%
'''

'''
probs:
Average Accuracy: 65.57%
Average Precision: 69.51%
Average Recall: 65.57%
Average F-score: 59.66%
'''